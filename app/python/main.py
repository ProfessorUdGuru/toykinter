...
class Main(Frame):
    ...
    def make_widgets(self):
        ...
        # for widg in ("notebook", "prefsbook"):
            # self.widg = TabBook
            # tabbed_widgets[widg] = self.widg
        ...
        # self.notebook = tabbed_widgets["notebook"](
            self,
            root=self.view, 
        ...
        # self.prefsbook = tabbed_widgets["prefsbook"](
            prefs,
            root=self.view,
        ...
        # tabbed_widgets["prefsbook"] = self.prefsbook
        print("line", looky(seeline()).lineno, "self.prefsbook.active:", self.prefsbook.active)
        ...
        # tabbed_widgets["notebook"] = self.notebook

        print("line", looky(seeline()).lineno, "self.notebook.active:", self.notebook.active)
...
# class Colorizer(Frame):
    ...
    # def recolorize(self):
        ...
        # print("line", looky(seeline()).lineno, "tabbed_widgets:", tabbed_widgets)
        # # this seems to be without python error but something has to be re-thought-out
        # #   it now does exactly what it did before I went to all the trouble of putting
        # #   the three classes in the same module and making a global dict for the tabbooks
        # for tabbook in tabbed_widgets.values():
            # tabbook.active.config(
                # bg=mbg,
                # fg=fg
            # )
