...
\u2022 Statusbar tooltips font size doesn't reconfigure till reloading the app. Try making a special method in the StatusbarTooltips class which is called in styles.config_generic(). See some examples which are called `colorize()`.
